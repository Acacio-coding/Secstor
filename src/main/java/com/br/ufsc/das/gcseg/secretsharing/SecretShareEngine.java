...
import com.br.ufsc.das.gcseg.pvss.PVSSSplitCombine;
...
public class SecretShareEngine {
	...
	* 	*/	
	public String combine(SharestoCombine genShares) throws UnsupportedEncodingException, InvalidVSSScheme{
		PVSSSplitCombine psc = new PVSSSplitCombine(n, k);
